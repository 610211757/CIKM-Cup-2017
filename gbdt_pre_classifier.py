...
def train():
    ...
    for k in range(4):
        ...
        os.chdir("E:\\Users\kingdom\TIANCHI\data\\machine_model")
        joblib.dump(gbdt, "rain_train_GBDT_" + str(k) + ".m")
        print("done = ", k)
        print("ddddddddddddddd")
...
def predict():
    ...
    gbdt1 = joblib.load("rain_train_GBDT_0.m")
    gbdt2 = joblib.load("rain_train_GBDT_1.m")
    gbdt3 = joblib.load("rain_train_GBDT_2.m")
    gbdt4 = joblib.load("rain_train_GBDT_3.m")
    result = []
    for i in range(2):
        print("1")
    ...
    print("4")
    save_file = "E:\\Users\kingdom\TIANCHI\data\\" + "GBDT_result_1" + ".txt"
    fl = open(save_file, 'w')
    for k in result:
        fl.write(str(k[0]))
        fl.write("\n")
